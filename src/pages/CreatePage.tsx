  ...
  <>
    ...
    <Container size="md" my="xl">
      <Stack gap="md">
        ...
        <Text>
          The Code Review prompt casts the AI as an expert auditor: it ingests an IMPLEMENTATION_PLAN, TECHNICAL_SPECIFICATION, and the current PROJECT_REQUEST, then delivers a structured critique covering architecture, code quality, security, performance, and best practices. It doesn’t just point out flaws, it crafts a prioritized improvement plan with concrete suggestions, from optimizing database queries to enhancing test coverage or refining API contracts.
        </Text>
        <Text>
          A hidden gem here is its ability to cross-reference the code against both the spec and the implementation plan, ensuring alignment between “what was supposed to be built” and “what was actually built.” It can even suggest missing unit tests and highlight risk areas (e.g., unhandled edge cases or concurrency pitfalls), acting as both a guardian of correctness and a coach for continuous improvement.
        </Text>
